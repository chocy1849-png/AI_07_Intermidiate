...
def generate_answer(
    ...
    return chain_generate(query, retrieved_docs, chat_history, eval_mode=eval_mode)
...
def answer_query(
    ...
    result = generate_answer(query, retrieved_docs, chat_history, eval_mode=eval_mode)
